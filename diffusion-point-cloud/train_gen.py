...
# Model arguments
parser.add_argument('--model', type=str, default='flow', choices=['flow', 'gaussian', 'flow_matching'])
...
train_dset, val_dset, test_dset = get_train_val_test_datasets(dset, train_ratio=0.80, val_ratio=0.20)
...
if args.model == 'gaussian':
    ...
    model = FlowMatch(args).to(args.device)
